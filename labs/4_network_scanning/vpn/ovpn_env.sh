...
declare -x OVPN_CN=midterm.csci3403.com
...
declare -x OVPN_PUSH=()
declare -x OVPN_ROUTES=([0]="192.168.248.0/22")
declare -x OVPN_SERVER=192.168.252.0/22
declare -x OVPN_SERVER_URL=udp://midterm.csci3403.com
